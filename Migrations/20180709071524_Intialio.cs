...
{
    public partial class Intialio : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedSpaceMB = table.Column<int>(nullable: false),
                    Credits = table.Column<long>(nullable: false),
                    ReportedSpamCount = table.Column<int>(nullable: false),
                    IsDeleted = table.Column<bool>(nullable: false),
                    SuperUser = table.Column<bool>(nullable: false),
                    LastPassowrdResetTime = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapthaText = table.Column<string>(nullable: true),
                    CapthaAnswer = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Capthas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    SpamCount = table.Column<long>(nullable: false),
                    HGTUserID = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SponseredVideo = table.Column<bool>(nullable: false),
                    HGTUserID = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
